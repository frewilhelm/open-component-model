...
require (
	...
	ocm.software/open-component-model/bindings/go/descriptor/normalisation v0.0.0-20260608114625-d2dfbaa48d4d // indirect
	ocm.software/open-component-model/bindings/go/helm v0.0.0-20260608114625-d2dfbaa48d4d // indirect
	ocm.software/open-component-model/bindings/go/signing v0.0.0-20260608115715-4d5a6e9d1768 // indirect
